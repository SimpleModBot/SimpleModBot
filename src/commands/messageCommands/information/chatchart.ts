...
module.exports = {
    ...
    async execute(message, args, data, client) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setDescription(`🥇**${Object.keys(finalthingyig)[0]}** │ \`${Object.values(finalthingyig)[0]} [${Object.values(finalthingyig)[0] / mLimit * 100}%]\`
...
🥉**${Object.keys(finalthingyig)[2]}** │ \`${Object.values(finalthingyig)[2]} [${Object.values(finalthingyig)[2] / mLimit * 100}%]\``)
            ...
            .setFooter(`This might not be very accurate.`)
            .setColor('GREY');
