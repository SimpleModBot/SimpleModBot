...
module.exports = class SocialCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    const twitchEmbed = new Discord.MessageEmbed()
      ...
      .setColor("#7716E9")
      .addField(
        "Check out my creators Twitch!",
        "I would like it if you followed and watched the streams."
      );
    ...
    const inviteEmbed = new Discord.MessageEmbed()
      .setTitle(
        "Invite me to your discord server to help grow my bot and help with your moderation!"
      )
