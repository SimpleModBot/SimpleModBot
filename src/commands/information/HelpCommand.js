...
module.exports = class HelpCommand extends BaseCommand {
  ...
  run(client, message, args) {
   ...
   .addField('Fun Commands \`fun\`', 'Commands that all users can user that are for fun and have no purpose.')
   .addField('Information commands \` information\`', 'Commands that return some form of important imformation.')
   .addField('Moderation commands \`moderation\`', 'Commands that are for moderation purposes within a server.')
