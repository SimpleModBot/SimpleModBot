...
module.exports = class HelpCommand extends BaseCommand {
  ...
  run(client, message, args) {
    const sectionEmbed = new Discord.MessageEmbed()
      ...
      .setDescription(
        "Use //help sectionName to access another section.\nSections: \nfun \nhelp \ninformation \nmoderation"
      )
      .addField(
        "Fun Commands",
        "Commands that all users can use that are for fun and have no true purpose."
      )
      .addField(
        "Help Commands",
        "Commands That are used for help with this bot."
      )
      .addField(
        "Information Commands",
        "Commands that return some information."
      )
      .addField(
        "Moderation Commands",
        "Commands that are for moderation within a server."
      )
    ...
    const infoEmbed = new Discord.MessageEmbed()
      ...
      .addField(
        "`Calc` Commands",
        "Allows you to calculate math problems with `+, -, x, or /`"
      )
      .addField(
        "`Servers` Commands",
        "Shows a more accurate and nicer counter of the bots server count."
      )
      .addField(
        "`Social` Command",
        "Displays social media in an embed and bot invite."
      )
      .addField(
        "`Suggest` Commands",
        "Displays your message as a suggestion for whatever server your in."
      )
      .addField(
        "`Vote` Command",
        "Creates a poll in the current channel for people to vote on something."
      )
      .addField(
        "`//website` Commands",
        "Sends a link to the official website!"
      );
    ...
    const helpEmbed = new Discord.MessageEmbed()
      ...
      .addField(
        "`LogIssue` or `Log`",
        "Sends your message into the log so you can report issues that I dont see in testing."
      )
      .addField(
        "`Support` Command",
        "Sends a link to the server where you can get support"
      );
