...
module.exports = {
    ...
    async execute(message, args, data, client) {
        ...
        message.channel.send({ content: '*If you have this clip without a watermark please dm it to me `DEATHB4DEFEAT#4404`*', files: [attachment], allowedMentions: { repliedUser: false } });
    },
};